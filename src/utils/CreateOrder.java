...
public class CreateOrder {
    ...
    public static void taoHD(ArrayList<Ve> danhSachGhe, HoaDon hd) {
        ...
        try {
            ...
            document.add(new Paragraph("Tàu: " +  danhSachGhe.get(0).getChuyenTau().getTau().getTenTau()+ "\n", getFont(12, Font.NORMAL)));
            document.add(new Paragraph("Chuyến đi: " + danhSachGhe.get(0).getChuyenTau().getTuyenDuong().getGaDi().getTenGa() + " --> " +danhSachGhe.get(0).getChuyenTau().getTuyenDuong().getGaDen().getTenGa() + "\n", getFont(12, Font.NORMAL)));
            DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm", Locale.ENGLISH);
            document.add(new Paragraph("Ngày đi: " + dateFormatter.format(danhSachGhe.get(0).getChuyenTau().getThoiGianDi()) + "\n", getFont(12, Font.NORMAL)));
            document.add(new Paragraph("Ngày đến dự kiến: " + dateFormatter.format(danhSachGhe.get(0).getChuyenTau().getThoiGianDen())+ "\n", getFont(12, Font.NORMAL)));
            document.add(new Paragraph("===========================================================\n", getFont(10, Font.NORMAL)));
            //Bảng ghế
            double tongTienVe = 0;
