...
public class CreateTicket {
    ...
    public static void taoVe(Ve ghe) {
        ...
        try {
            ...
            document.add(new Paragraph("Tàu: " +  ghe.getChuyenTau().getTau().getTenTau()+ "\n", getFont(12, Font.NORMAL)));
            document.add(new Paragraph("Chuyến đi: " + ghe.getChuyenTau().getTuyenDuong().getGaDi().getTenGa() + " --> " +ghe.getChuyenTau().getTuyenDuong().getGaDen().getTenGa() + "\n", getFont(12, Font.NORMAL)));
            DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm", Locale.ENGLISH);
            document.add(new Paragraph("Ngày đi: " + dateFormatter.format(ghe.getChuyenTau().getThoiGianDi()) + "\n", getFont(12, Font.NORMAL)));
            document.add(new Paragraph("Ngày đến dự kiến: " + dateFormatter.format(ghe.getChuyenTau().getThoiGianDen())+ "\n", getFont(12, Font.NORMAL)));
