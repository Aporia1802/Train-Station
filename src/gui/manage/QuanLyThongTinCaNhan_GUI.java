...
public class QuanLyThongTinCaNhan_GUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pwd_matKhauHT.putClientProperty(FlatClientProperties.STYLE, "arc:10;" + "" + "showRevealButton:true;");
        jPanel8.add(pwd_matKhauMoi);
        pwd_matKhauMoi.putClientProperty(FlatClientProperties.STYLE, "arc:10;" + "" + "showRevealButton:true;");
        jPanel8.add(pwd_xacNhan);
        pwd_xacNhan.putClientProperty(FlatClientProperties.STYLE, "arc:10;" + "" + "showRevealButton:true;");
