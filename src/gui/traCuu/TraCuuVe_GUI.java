        ...
        for (Ve ve : dsVe) {
            try {
                String[] row = {
                    ...
                    ve.getChuyenDi() != null && ve.getChuyenDi().getTau() != null ? 
                        ve.getChuyenDi().getTau().getTenTau() : "",
                    ve.getChuyenDi() != null && ve.getChuyenDi().getTuyenDuong() != null && 
                        ve.getChuyenDi().getTuyenDuong().getGaDi() != null ?
                        ve.getChuyenDi().getTuyenDuong().getGaDi().getTenGa() : "",
                    ve.getChuyenDi() != null && ve.getChuyenDi().getTuyenDuong() != null && 
                        ve.getChuyenDi().getTuyenDuong().getGaDen() != null ?
                        ve.getChuyenDi().getTuyenDuong().getGaDen().getTenGa() : "",
                    ve.getChuyenDi() != null && ve.getChuyenDi().getThoiGianDi() != null ?
                        ve.getChuyenDi().getThoiGianDi().format(dateTimeFormatter) : "",
                    ve.getChuyenDi() != null && ve.getChuyenDi().getThoiGianDen() != null ?
                        ve.getChuyenDi().getThoiGianDen().format(dateTimeFormatter) : "",
